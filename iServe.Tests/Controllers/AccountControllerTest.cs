...
namespace iServe.Tests.Controllers {
	...
	//        string newPass = "badPass";
	//        string confirmPass = "badPass";
	//        int minPasswordLength = 4;

	//        IFormsAuthentication formsAuth = new MockFormsAuthenticationService();
	//        //var mockMembershipProvider = new Mock<iServe.Models.Account.MembershipProvider>();
	//        var mockMembershipService = new Mock<AccountMembershipService>();// new AccountMembershipService(mockMembershipProvider.Object);
	//        AccountController controller = new AccountController(formsAuth, mockMembershipService.Object);
	//        ControllerContext controllerContext = new ControllerContext(new MockHttpContext(), new RouteData(), controller);
	//        controller.ControllerContext = controllerContext;

	//        mockMembershipService.Expect(s => s.MinPasswordLength).Returns(minPasswordLength);
	//        mockMembershipService.Expect(s => s.ChangePassword("", newPass, currentPass)).Returns(false);

	//        // Act
	//        ViewResult result = (ViewResult)controller.ChangePassword(currentPass, newPass, confirmPass);
	...
	//        IFormsAuthentication formsAuth = new MockFormsAuthenticationService();
	//        var mockMembershipProvider = new Mock<iServe.Models.Account.MembershipProvider>();
	//        AccountMembershipService membershipService = new AccountMembershipService(mockMembershipProvider.Object);
	//        AccountController controller = new AccountController(formsAuth, membershipService);
	//        ControllerContext controllerContext = new ControllerContext(new MockHttpContext(), new RouteData(), controller);
	//        controller.ControllerContext = controllerContext;
	//        return controller;
	...
	//    //public class MockMembershipProvider : iServe.Models.Account.MembershipProvider {
