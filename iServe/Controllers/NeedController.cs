...
namespace iServe.Controllers {
	public class NeedController : iServeController, IDotNailsController {
		...
		public ActionResult iNeed() {
            ...
            var openNeeds = needs.Where(need => ((NeedStatusEnum)need.NeedStatusID == NeedStatusEnum.Met && unratedCommittedUsers.Contains(need.ID)) || ((NeedStatusEnum)need.NeedStatusID != NeedStatusEnum.Cancelled) && (NeedStatusEnum)need.NeedStatusID != NeedStatusEnum.Met);
